...
# Read data
df = pd.read_csv("../data/output_csv_files/results_padding_DE.csv", delimiter='\t')
...
ax.set_title("Statistically Male Professions German with Padding", fontsize=16)
...
# Save plot
plt.savefig('../data/plots/statistically_male_professions_DE_padding.png',
            bbox_inches='tight')
...
# Set title for the plot
ax.set_title("Statistically Female Professions German with Padding", fontsize=16)
...
# Save plot
plt.savefig('../data/plots/statistically_female_professions_DE_padding.png',
            bbox_inches='tight')
...
# Set title for the plot
ax.set_title("Statistically Balanced Professions German with Padding", fontsize=16)
...
# Save plot
plt.savefig('../data/plots/statistically_balanced_professions_DE_padding.png',
            bbox_inches='tight')
