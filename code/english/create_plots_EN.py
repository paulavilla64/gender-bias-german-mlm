...
# Read data
df = pd.read_csv("../data/output_csv_files/results_padding_EN.csv", delimiter='\t')
...
axes[0].set_title("Statistically Male Professions with padding", fontsize=16)
...
# Save plot
plt.savefig("../data/plots/statistically_male_professions_with_padding.png",
            bbox_inches='tight')
plt.show()
...
# Set title for the first plot
axes[0].set_title("Statistically Female Professions with Padding", fontsize=16)
...
# Save plot
plt.savefig("../data/plots/statistically_female_professions_with_padding.png",
            bbox_inches='tight')
plt.show()
...
# Set title for the first plot
axes[0].set_title("Statistically Balanced Professions with Padding", fontsize=16)
...
# Save plot
plt.savefig("../data/plots/statistically_balanced_professions_with_padding.png",
            bbox_inches='tight')
plt.show()
